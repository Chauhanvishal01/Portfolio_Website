...
const logoMap = {
  ...
  "TanStack Query": "./assests/logos/tanstack.png",
  "Tailwind CSS": "./assests/logos/tailwind.png",
  "DaisyUI / ShadcnUI": "./assests/logos/daisyui.png",
  "Git & Github": "./assests/logos/git.png",
  Deployment: "./assests/logos/github.png",
};
...
const projects = [
  {
    ...
    description:
      "An end-to-end Job Portal application featuring secure authentication and dynamic job listings.",
    link: "https://github.com/Chauhanvishal01/Jop-Portal-Web-App",
    image: "./assests/project_img/project1.png",
  },
  {
  ...
  },
  {
    ...
    link: "https://github.com/Chauhanvishal01",
